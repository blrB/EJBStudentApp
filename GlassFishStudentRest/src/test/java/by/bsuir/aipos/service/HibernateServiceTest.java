...
@PrepareForTest(StudentEntityManagerFactory.class)
...
public class HibernateServiceTest {
    ...
    public void init() throws ParseException {
        ...
        student = new Student(
                ...
                studentGroup);
        student.setId(1);
        PowerMockito.mockStatic(StudentEntityManagerFactory.class);
        entityManager = mock(EntityManager.class);
        when(StudentEntityManagerFactory.createEntityManager()).thenReturn(entityManager);
